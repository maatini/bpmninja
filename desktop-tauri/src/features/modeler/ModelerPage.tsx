      ...
      modeler.on('import.done', async ({ error }: any) => {
        if (!error) {
          ...
          try {
            ...
            console.error('Failed to save XML after import', e);
          }
        }
      });
  ...
  return (
    <div className="flex flex-col h-full overflow-hidden bg-background">
      <div className="header-actions flex items-center gap-2 px-6 py-3 border-b bg-background shadow-sm z-10 flex-shrink-0">
        ...
        <Button size="sm" onClick={() => setShowVarsDialog(true)} className="gap-2 bg-green-600 hover:bg-green-700 text-white">
