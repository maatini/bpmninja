...
#[tauri::command]
pub async fn deploy_definition(state: tauri::State<'_, AppState>, xml: String, name: String) -> Result<String, String> {
...
#[tauri::command]
pub async fn list_definitions(state: tauri::State<'_, AppState>) -> Result<serde_json::Value, String> {
    crate::api_helpers::api_get(&state, "/api/definitions").await
}

#[tauri::command]
pub async fn get_definition_xml(state: tauri::State<'_, AppState>, definition_id: String) -> Result<String, String> {
...
#[tauri::command]
pub async fn delete_definition(state: tauri::State<'_, AppState>, definition_id: String, cascade: bool) -> Result<(), String> {
