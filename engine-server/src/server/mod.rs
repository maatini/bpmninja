...
pub fn build_app_with_engine(
    ...
    Router::new()
        ...
        .route("/api/instances/:id", get(instances::get_instance).delete(instances::delete_instance))
        ...
        .route("/api/instances/:id/history", get(history::get_instance_history))
        ...
        .route("/api/service-task/fetchAndLock", post(tasks::fetch_and_lock_service_tasks))
        .route("/api/service-task/:id/complete", post(tasks::complete_service_task))
        .route("/api/service-task/:id/failure", post(tasks::fail_service_task))
