...
## Corpus Check
- 190 files · ~299,324 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 1245 nodes · 3685 edges · 107 communities detected
- Extraction: 37% EXTRACTED · 63% INFERRED · 0% AMBIGUOUS · INFERRED: 2321 edges (avg confidence: 0.8)
...
Cohesion: 0.06
Nodes (174): api_post(), complete_task_for_node(), compliance_complex_gateway_activation(), compliance_exclusive_gateway_routing(), compliance_parallel_gateway_sync(), create_engine(), test_complex_gateway_join_condition(), test_complex_gateway_split_and_default() (+166 more)

### Community 1 - "Community 1"
Cohesion: 0.05
Nodes (34): WorkflowEngine, evaluate_condition(), ProcessDefinition, groupByProcess(), WorkflowEngine, execute_complex_gateway(), execute_exclusive_gateway(), execute_inclusive_gateway() (+26 more)

### Community 2 - "Community 2"
Cohesion: 0.02
Nodes (66): handleDeploy(), handleStart(), confirmDelete(), handleDownload(), handleView(), handleSearch(), handleResolve(), handleRetry() (+58 more)

### Community 3 - "Community 3"
Cohesion: 0.03
Nodes (77): api_delete(), api_get(), api_post_no_body(), api_put(), DefinitionInfo, delete_definition(), DeleteDefinitionQuery, DeployRequest (+69 more)
...
Cohesion: 0.05
Nodes (27): parse_rhs(), test_equality(), test_numeric_comparisons(), test_parse_rhs_quoted_strings(), test_truthy(), values_cmp(), values_eq(), arb_instance_state() (+19 more)

### Community 6 - "Community 6"
Cohesion: 0.06
Nodes (16): NatsPersistence, list_completed_instances(), main(), restore_from_nats(), shutdown_signal(), create_retry_queue(), execute_job(), PersistJob (+8 more)
...
Cohesion: 0.09
Nodes (8): WorkflowEngine, delete_all_definitions(), Value, start_instance_latest(), CorrelateMessageRequest, CorrelateMessageResponse, get_pending_messages(), DefinitionRegistry
...
## Knowledge Gaps
- **119 isolated node(s):** `BpmnMultiInstanceLoopCharacteristics`, `BpmnLoopCardinality`, `BpmnExtensionElements`, `BpmnExecutionListener`, `BpmnScript` (+114 more)
  These have ≤1 connection - possible missing edges or undocumented components.
- **Thin community `Community 31`** (2 nodes): `main()`, `test_cron.rs`
...
- **Why does `fetchTasks()` connect `Community 2` to `Community 1`?**
